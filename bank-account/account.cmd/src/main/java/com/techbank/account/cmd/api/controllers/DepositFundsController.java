...
public class DepositFundsController {
    ...
    public ResponseEntity<BaseResponse> depositFunds(@PathVariable(value = "id") String id,
        ...
        try {
            ...
            return new ResponseEntity<>(new BaseResponse("Fund deposited successfully"), HttpStatus.OK);
            ...
            String errMessage = MessageFormat.format("Error while processing request to deposit fund for id -{0}.", id);
